...
const MeetingTypeList = () => {
  ...
  const createMeeting = async () => { // Make the function async
      ...
      {!callDetails ? (
        ...
        >
          <div className="flex flex-col gap-2.5">
            <label className="text-base text-normal leading-[22px] text-sky-2">Add a decription </label>
...
<MeetingModal isOpen={meetingState === 'isJoiningMeeting'}
        ...
        className="text-center"
        buttonText="Joning meeting" 
        handleClick={() => router.push(values.link)} >
                   <Input 
                   placeholder="Meeting link"
                   className="border-none bg-dark-3 focus-visibility:ring-0 focus-visibility:ring-offset-0"
